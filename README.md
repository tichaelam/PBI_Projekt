...
## Zadavatel/odběratel
- zadavatelem můžou být vládní agentury, státní sektor, humanitární organizace, či informační kanály, které využijí podklady:
 - počtech obětí,
 - druzích politického násilí, či
 - nárůstu efektivity různých typů dronů na bojišti, a to
...
že masové vypouštění swarmů ruských dronů Shahed může znamenat nárůst fabrik na výrobu tohoto typu dronu a může vést k relokaci finančních zdrojů pro
